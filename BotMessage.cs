...
namespace Lesson26.BotMessage
{
    ...
    {
        public Task CommunicateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken);
    }
    class BotMessage(ILogger<BotMessage> logger) : IBotMessage
    {
        public async Task CommunicateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
